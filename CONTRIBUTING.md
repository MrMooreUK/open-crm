...
- **UI** stays calm: zinc neutrals + restrained teal primary; dense tables; no flashy multi-colour chrome. See [docs/ui.md](./docs/ui.md).
- **Primary CTAs** use brand (`Button` or `.btn-primary`), not bare `bg-zinc-900` or gradient stacks.
