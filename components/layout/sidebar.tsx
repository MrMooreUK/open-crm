...
const navSections: NavSection[] = [
  {
    ...
    eyebrow: "Today",
    items: [
      { href: "/", label: "Home", icon: Home, accent: "from-sky-500 to-indigo-500" },
      { href: "/pipeline", label: "Pipeline", icon: Kanban, accent: "from-violet-500 to-fuchsia-500" },
      { href: "/tasks", label: "Tasks", icon: CheckSquare, accent: "from-emerald-500 to-teal-500" },
    ],
  },
  {
    id: "crm",
    ...
    eyebrow: "Records",
    items: [
      { href: "/deals", label: "Deals", icon: Handshake, accent: "from-amber-500 to-orange-500" },
      { href: "/companies", label: "Companies", icon: Building2, accent: "from-cyan-500 to-blue-500" },
      { href: "/contacts", label: "Contacts", icon: Contact, accent: "from-rose-500 to-pink-500" },
    ],
  },
  {
    id: "admin",
    ...
    eyebrow: "Setup",
    items: [
      { href: "/settings", label: "Settings", icon: Settings, accent: "from-slate-500 to-zinc-700" },
    ],
  },
];
    ...
    <aside className="relative flex w-60 shrink-0 flex-col overflow-hidden border-r border-indigo-100/80 bg-gradient-to-b from-slate-950 via-slate-950 to-indigo-950 text-white shadow-2xl shadow-indigo-950/20">
      ...
      <div className="relative border-t border-white/10 p-3">
        <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-3 text-xs text-indigo-50">
          ...
          <div className="mt-0.5 text-indigo-100/70">Collapse sections to stay focused.</div>
        </div>
      </div>
    </aside>
  );
